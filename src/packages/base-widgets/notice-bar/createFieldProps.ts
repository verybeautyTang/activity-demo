...
export const createFieldProps = () => ({
  ...
  leftIcon: createEditorInputProp({
    label: "左侧图标名称或图片链接",
    defaultValue: "volume-o",
  }),
  ...
  scrollable: createEditorSwitchProp({
    label: "是否开启滚动播放，内容长度溢出时默认开启",
  }),
  ...
  wrapable: createEditorSwitchProp({
    label: "是否开启文本换行，只在禁用滚动时生效",
  }),
});
