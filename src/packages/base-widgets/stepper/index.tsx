...
export default {
  ...
  props: {
    ...
    ...createFieldProps(),
    allowEmpty: createEditorSwitchProp({
      label: "是否允许输入的值为空",
      defaultValue: false,
    }),
    ...
    decimalLength: createEditorInputProp({
      label: "固定显示的小数位数",
      defaultValue: "",
    }),
    ...
    disableInput: createEditorSwitchProp({
      label: "是否禁用输入框",
      defaultValue: false,
    }),
    disableMinus: createEditorSwitchProp({
      label: "是否禁用减少按钮",
      defaultValue: false,
    }),
    disablePlus: createEditorSwitchProp({
      label: "是否禁用增加按钮",
      defaultValue: false,
    }),
    ...
    inputWidth: createEditorInputProp({
      label: "输入框宽度，默认单位为 px",
      defaultValue: "32px",
    }),
    integer: createEditorSwitchProp({
      label: "是否只允许输入整数",
      defaultValue: false,
    }),
    longPress: createEditorSwitchProp({
      label: "是否开启长按手势",
      defaultValue: true,
    }),
    ...
    showMinus: createEditorSwitchProp({
      label: "是否显示减少按钮",
      defaultValue: true,
    }),
    showPlus: createEditorSwitchProp({
      label: "是否显示增加按钮",
      defaultValue: true,
    }),
