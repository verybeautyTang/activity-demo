...
export default {
  ...
  render: ({ props, styles }) => {
    const RenderProgress = () => (
      <Progress {...props} pivotText={props.pivotText || undefined} />
    );
  ...
  props: {
    ...
    inactive: createEditorSwitchProp({
      label: "是否置灰",
      defaultValue: false,
    }),
    ...
    trackColor: createEditorColorProp({
      label: "轨道颜色",
      defaultValue: "#e5e5e5",
    }),
    pivotText: createEditorInputProp({ label: "进度文字内容" }),
    pivotColor: createEditorColorProp({
      label: "进度文字背景色",
      defaultValue: "#1989fa",
    }),
    ...
    showPivot: createEditorSwitchProp({
      label: "是否显示进度文字",
      defaultValue: true,
    }),
  },
